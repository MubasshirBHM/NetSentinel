...
It allows non-technical users to set up a hotspot, monitor connected devices, approve/block them, and sync DNS blocklists from Firebase.  
...
- Firebase integration for logging + remote control  
